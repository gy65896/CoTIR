...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    local_path = os.environ.get("FLUX_T5_PATH")
    local_tokenizer_path = os.environ.get("FLUX_T5_TOKENIZER_PATH")
    if local_path:
        tokenizer_source = local_tokenizer_path or local_path
        return HFEmbedder(
            local_path,
...
def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    local_path = os.environ.get("FLUX_CLIP_PATH")
    local_tokenizer_path = os.environ.get("FLUX_CLIP_TOKENIZER_PATH")
    if local_path:
        tokenizer_source = local_tokenizer_path or local_path
        return HFEmbedder(
            local_path,
